...
count_file <- "/mnt/projects/users/aalayeva/smallRNA/smRNA_STAR_RESULT/aligned_deduplicated/featureCounts_results/optional/count_edited_matrix_toGenome.txt"
